...
func HasVenueEntryWith(preds ...predicate.VenueEntry) predicate.Venue {
	return predicate.Venue(func(s *sql.Selector) {
...
func HasProducts() predicate.Venue {
	return predicate.Venue(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasProductsWith(preds ...predicate.Product) predicate.Venue {
	return predicate.Venue(func(s *sql.Selector) {
...
func HasRolesWith(preds ...predicate.Role) predicate.Venue {
	return predicate.Venue(func(s *sql.Selector) {
		step := newRolesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {

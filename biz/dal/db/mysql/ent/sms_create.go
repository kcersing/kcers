...
func (sc *SmsCreate) SetNoticeCount(i int64) *SmsCreate {
	sc.mutation.SetNoticeCount(i)
	return sc
}

// SetNillableNoticeCount sets the "notice_count" field if the given value is not nil.
func (sc *SmsCreate) SetNillableNoticeCount(i *int64) *SmsCreate {
	if i != nil {
		sc.SetNoticeCount(*i)
	}
	return sc
...
func (sc *SmsCreate) SetUsedNotice(i int64) *SmsCreate {
	sc.mutation.SetUsedNotice(i)
	return sc
}

// SetNillableUsedNotice sets the "used_notice" field if the given value is not nil.
func (sc *SmsCreate) SetNillableUsedNotice(i *int64) *SmsCreate {
	if i != nil {
		sc.SetUsedNotice(*i)
	}
	return sc
...
func (sc *SmsCreate) defaults() {
	...
	if _, ok := sc.mutation.NoticeCount(); !ok {
		v := sms.DefaultNoticeCount
		sc.mutation.SetNoticeCount(v)
	}
	if _, ok := sc.mutation.UsedNotice(); !ok {
		v := sms.DefaultUsedNotice
		sc.mutation.SetUsedNotice(v)
	}
}

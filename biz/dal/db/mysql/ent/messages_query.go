...
func (mq *MessagesQuery) FirstIDX(ctx context.Context) int64 {
...
func (mq *MessagesQuery) OnlyIDX(ctx context.Context) int64 {
...
func (mq *MessagesQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (mq *MessagesQuery) IDsX(ctx context.Context) []int64 {
	ids, err := mq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(messages.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Messages.Query().
//		Select(messages.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (mq *MessagesQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(messages.Table, messages.Columns, sqlgraph.NewFieldSpec(messages.FieldID, field.TypeInt64))
	_spec.From = mq.sql

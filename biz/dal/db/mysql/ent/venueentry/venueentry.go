...
const (
	// Label holds the string label denoting the venueentry type in the database.
	Label = "venue_entry"
	...
	// Table holds the table name of the venueentry in the database.
	Table = "entry_logs"
...
// Columns holds all SQL columns for venueentry fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the VenueEntry queries.

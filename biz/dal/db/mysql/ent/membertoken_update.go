...
func (mtu *MemberTokenUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *MemberTokenUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (mtuo *MemberTokenUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *MemberTokenUpdateOne {

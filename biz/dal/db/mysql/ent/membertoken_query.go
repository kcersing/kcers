...
func (mtq *MemberTokenQuery) Modify(modifiers ...func(s *sql.Selector)) *MemberTokenSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (mts *MemberTokenSelect) Modify(modifiers ...func(s *sql.Selector)) *MemberTokenSelect {

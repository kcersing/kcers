...
func (slq *SmsLogQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (slq *SmsLogQuery) FirstIDX(ctx context.Context) int64 {
...
func (slq *SmsLogQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (slq *SmsLogQuery) OnlyIDX(ctx context.Context) int64 {
...
func (slq *SmsLogQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (slq *SmsLogQuery) IDsX(ctx context.Context) []int64 {
	ids, err := slq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (slq *SmsLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(smslog.Table, smslog.Columns, sqlgraph.NewFieldSpec(smslog.FieldID, field.TypeInt64))
	_spec.From = slq.sql

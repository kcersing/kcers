...
func (sq *ScheduleQuery) QueryMembers() *ScheduleMemberQuery {
	query := (&ScheduleMemberClient{config: sq.config}).Query()
...
func (sq *ScheduleQuery) QueryCoachs() *ScheduleCoachQuery {
	query := (&ScheduleCoachClient{config: sq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := sq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (sq *ScheduleQuery) FirstIDX(ctx context.Context) int64 {
...
func (sq *ScheduleQuery) OnlyIDX(ctx context.Context) int64 {
...
func (sq *ScheduleQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (sq *ScheduleQuery) IDsX(ctx context.Context) []int64 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *ScheduleQuery) Clone() *ScheduleQuery {
	...
	return &ScheduleQuery{
		...
		withCoachs:  sq.withCoachs.Clone(),
...
func (sq *ScheduleQuery) WithMembers(opts ...func(*ScheduleMemberQuery)) *ScheduleQuery {
	query := (&ScheduleMemberClient{config: sq.config}).Query()
...
func (sq *ScheduleQuery) WithCoachs(opts ...func(*ScheduleCoachQuery)) *ScheduleQuery {
	query := (&ScheduleCoachClient{config: sq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(schedule.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Schedule.Query().
//		Select(schedule.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (sq *ScheduleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Schedule, error) {
	...
	if query := sq.withMembers; query != nil {
		if err := sq.loadMembers(ctx, query, nodes,
			func(n *Schedule) { n.Edges.Members = []*ScheduleMember{} },
			func(n *Schedule, e *ScheduleMember) { n.Edges.Members = append(n.Edges.Members, e) }); err != nil {
			return nil, err
		}
	}
	if query := sq.withCoachs; query != nil {
		if err := sq.loadCoachs(ctx, query, nodes,
			func(n *Schedule) { n.Edges.Coachs = []*ScheduleCoach{} },
			func(n *Schedule, e *ScheduleCoach) { n.Edges.Coachs = append(n.Edges.Coachs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (sq *ScheduleQuery) loadMembers(ctx context.Context, query *ScheduleMemberQuery, nodes []*Schedule, init func(*Schedule), assign func(*Schedule, *ScheduleMember)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Schedule)
	for i := range nodes {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(schedulemember.FieldScheduleID)
	}
	query.Where(predicate.ScheduleMember(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(schedule.MembersColumn), fks...))
	}))
...
func (sq *ScheduleQuery) loadCoachs(ctx context.Context, query *ScheduleCoachQuery, nodes []*Schedule, init func(*Schedule), assign func(*Schedule, *ScheduleCoach)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Schedule)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(schedulecoach.FieldScheduleID)
	}
	query.Where(predicate.ScheduleCoach(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(schedule.CoachsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (sq *ScheduleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(schedule.Table, schedule.Columns, sqlgraph.NewFieldSpec(schedule.FieldID, field.TypeInt64))
	_spec.From = sq.sql

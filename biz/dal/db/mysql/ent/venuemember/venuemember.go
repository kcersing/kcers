...
const (
	// Label holds the string label denoting the venuemember type in the database.
	Label = "venue_member"
	...
	EdgeMember = "member"
	// Table holds the table name of the venuemember in the database.
...
// Columns holds all SQL columns for venuemember fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the VenueMember queries.

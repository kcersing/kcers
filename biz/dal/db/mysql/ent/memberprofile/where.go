...
func RelationUID(v int64) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldEQ(FieldRelationUID, v))
}

// RelationUname applies equality check predicate on the "relation_uname" field. It's identical to RelationUnameEQ.
func RelationUname(v string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldEQ(FieldRelationUname, v))
}
...
func RelationUIDEQ(v int64) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldEQ(FieldRelationUID, v))
}

// RelationUIDNEQ applies the NEQ predicate on the "relation_uid" field.
func RelationUIDNEQ(v int64) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldNEQ(FieldRelationUID, v))
}

// RelationUIDIn applies the In predicate on the "relation_uid" field.
func RelationUIDIn(vs ...int64) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldIn(FieldRelationUID, vs...))
}

// RelationUIDNotIn applies the NotIn predicate on the "relation_uid" field.
func RelationUIDNotIn(vs ...int64) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldNotIn(FieldRelationUID, vs...))
}

// RelationUIDGT applies the GT predicate on the "relation_uid" field.
func RelationUIDGT(v int64) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldGT(FieldRelationUID, v))
}

// RelationUIDGTE applies the GTE predicate on the "relation_uid" field.
func RelationUIDGTE(v int64) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldGTE(FieldRelationUID, v))
}

// RelationUIDLT applies the LT predicate on the "relation_uid" field.
func RelationUIDLT(v int64) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldLT(FieldRelationUID, v))
}

// RelationUIDLTE applies the LTE predicate on the "relation_uid" field.
func RelationUIDLTE(v int64) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldLTE(FieldRelationUID, v))
}

// RelationUIDIsNil applies the IsNil predicate on the "relation_uid" field.
func RelationUIDIsNil() predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldIsNull(FieldRelationUID))
}

// RelationUIDNotNil applies the NotNil predicate on the "relation_uid" field.
func RelationUIDNotNil() predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldNotNull(FieldRelationUID))
}

// RelationUnameEQ applies the EQ predicate on the "relation_uname" field.
func RelationUnameEQ(v string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldEQ(FieldRelationUname, v))
}

// RelationUnameNEQ applies the NEQ predicate on the "relation_uname" field.
func RelationUnameNEQ(v string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldNEQ(FieldRelationUname, v))
}

// RelationUnameIn applies the In predicate on the "relation_uname" field.
func RelationUnameIn(vs ...string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldIn(FieldRelationUname, vs...))
}

// RelationUnameNotIn applies the NotIn predicate on the "relation_uname" field.
func RelationUnameNotIn(vs ...string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldNotIn(FieldRelationUname, vs...))
}

// RelationUnameGT applies the GT predicate on the "relation_uname" field.
func RelationUnameGT(v string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldGT(FieldRelationUname, v))
}

// RelationUnameGTE applies the GTE predicate on the "relation_uname" field.
func RelationUnameGTE(v string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldGTE(FieldRelationUname, v))
}

// RelationUnameLT applies the LT predicate on the "relation_uname" field.
func RelationUnameLT(v string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldLT(FieldRelationUname, v))
}

// RelationUnameLTE applies the LTE predicate on the "relation_uname" field.
func RelationUnameLTE(v string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldLTE(FieldRelationUname, v))
}

// RelationUnameContains applies the Contains predicate on the "relation_uname" field.
func RelationUnameContains(v string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldContains(FieldRelationUname, v))
}

// RelationUnameHasPrefix applies the HasPrefix predicate on the "relation_uname" field.
func RelationUnameHasPrefix(v string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldHasPrefix(FieldRelationUname, v))
}

// RelationUnameHasSuffix applies the HasSuffix predicate on the "relation_uname" field.
func RelationUnameHasSuffix(v string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldHasSuffix(FieldRelationUname, v))
}

// RelationUnameIsNil applies the IsNil predicate on the "relation_uname" field.
func RelationUnameIsNil() predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldIsNull(FieldRelationUname))
}

// RelationUnameNotNil applies the NotNil predicate on the "relation_uname" field.
func RelationUnameNotNil() predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldNotNull(FieldRelationUname))
}

// RelationUnameEqualFold applies the EqualFold predicate on the "relation_uname" field.
func RelationUnameEqualFold(v string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldEqualFold(FieldRelationUname, v))
}

// RelationUnameContainsFold applies the ContainsFold predicate on the "relation_uname" field.
func RelationUnameContainsFold(v string) predicate.MemberProfile {
	return predicate.MemberProfile(sql.FieldContainsFold(FieldRelationUname, v))
}

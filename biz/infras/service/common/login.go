...
func (l *Login) UserLogin(username, password string) (res *do.LoginResp, err error) {
...
func (l *Login) MemberLogin(username, password string) (res *do.LoginResp, err error) {
	//TODO implement me
	panic("implement me")
}

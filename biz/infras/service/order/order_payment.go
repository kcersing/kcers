...
//func (o *Order) UnifyPay(req payment.UnifyPayReq) error {
...
//		return service.Rollback(tx, errors.Wrap(err, "创建支付信息失败"))
//	}
//
...
//
//	if err != nil {
//		return service.Rollback(tx, errors.Wrap(err, "订单金额修改失败"))
//	}
//
//	if (amount.Residue - req.Remission - req.Payment) == 0 {
//
...
//
//		if err != nil {
//			return service.Rollback(tx, errors.Wrap(err, "会员产品属性修改失败"))
//		}

...
var MenuInfo_Key_DEFAULT string = ""

func (p *MenuInfo) GetKey() (v string) {
	if !p.IsSetKey() {
		return MenuInfo_Key_DEFAULT
	}
	return p.Key
}
...
var MenuInfo_Ignore_DEFAULT string = ""

func (p *MenuInfo) GetIgnore() (v string) {
	if !p.IsSetIgnore() {
		return MenuInfo_Ignore_DEFAULT
	}
	return p.Ignore
}
...
func (p *MenuInfo) IsSetKey() bool {
	return p.Key != MenuInfo_Key_DEFAULT
}

func (p *MenuInfo) IsSetOrderNo() bool {
	return p.OrderNo != MenuInfo_OrderNo_DEFAULT
}

func (p *MenuInfo) IsSetDisabled() bool {
	return p.Disabled != MenuInfo_Disabled_DEFAULT
}

func (p *MenuInfo) IsSetIgnore() bool {
	return p.Ignore != MenuInfo_Ignore_DEFAULT
}
...
func (p *MenuInfo) ReadField23(iprot thrift.TProtocol) error {
...
func (p *MenuInfo) writeField20(oprot thrift.TProtocol) (err error) {
	if p.IsSetKey() {
		if err = oprot.WriteFieldBegin("key", thrift.STRING, 20); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *MenuInfo) writeField23(oprot thrift.TProtocol) (err error) {
	if p.IsSetIgnore() {
		if err = oprot.WriteFieldBegin("ignore", thrift.STRING, 23); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(p.Ignore); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
type MenuListReq struct {
	Page     int64  `thrift:"page,1,optional" form:"page" json:"page" query:"page"`
	PageSize int64  `thrift:"pageSize,2,optional" form:"pageSize" json:"pageSize" query:"pageSize"`
	Type     string `thrift:"type,19,optional" form:"type" json:"type" query:"type"`
}
...
func (p *MenuListReq) ReadField19(iprot thrift.TProtocol) error {
...
func (p *MenuListReq) writeField19(oprot thrift.TProtocol) (err error) {
	if p.IsSetType() {
...
func (p *ListApiReq) InitDefault() {
	p.Page = 1
	p.PageSize = 100
}

var ListApiReq_Page_DEFAULT int64 = 1

func (p *ListApiReq) GetPage() (v int64) {
	if !p.IsSetPage() {
		return ListApiReq_Page_DEFAULT
	}
	return p.Page
}

var ListApiReq_PageSize_DEFAULT int64 = 100

func (p *ListApiReq) GetPageSize() (v int64) {
	if !p.IsSetPageSize() {
		return ListApiReq_PageSize_DEFAULT
	}
	return p.PageSize
}

var fieldIDToName_ListApiReq = map[int16]string{
	1: "page",
	2: "pageSize",
}

func (p *ListApiReq) IsSetPage() bool {
	return p.Page != ListApiReq_Page_DEFAULT
}

func (p *ListApiReq) IsSetPageSize() bool {
	return p.PageSize != ListApiReq_PageSize_DEFAULT
}

func (p *ListApiReq) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ListApiReq[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ListApiReq) ReadField1(iprot thrift.TProtocol) error {
...
func (p *ListApiReq) ReadField2(iprot thrift.TProtocol) error {
...
func (p *ListApiReq) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("ListApiReq"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *ListApiReq) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetPage() {
		if err = oprot.WriteFieldBegin("page", thrift.I64, 1); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *ListApiReq) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetPageSize() {
		if err = oprot.WriteFieldBegin("pageSize", thrift.I64, 2); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *ListApiReq) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ListApiReq(%+v)", *p)

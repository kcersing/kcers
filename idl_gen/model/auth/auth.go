...
type MenuAuthInfoReq struct {
	RoleId  int64   `thrift:"roleId,1" form:"roleId" json:"roleId" query:"roleId"`
	MenuIds []int64 `thrift:"menuIds,2" form:"menuIds" json:"menuIds" query:"menuIds"`
}
...
func (p *MenuAuthInfoReq) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("menuIds", thrift.LIST, 2); err != nil {
		goto WriteFieldBeginError
	}
...
type RoleMenu struct {
	MenuIds  []int64          `thrift:"menuIds,1" form:"menuIds" json:"menuIds" query:"menuIds"`
	MenuInfo []*menu.MenuInfo `thrift:"menuInfo,2" form:"menuInfo" json:"menuInfo" query:"menuInfo"`
}
...
func (p *RoleMenu) InitDefault() {
}

func (p *RoleMenu) GetMenuIds() (v []int64) {
	return p.MenuIds
}

func (p *RoleMenu) GetMenuInfo() (v []*menu.MenuInfo) {
	return p.MenuInfo
}

var fieldIDToName_RoleMenu = map[int16]string{
	1: "menuIds",
	2: "menuInfo",
}

func (p *RoleMenu) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RoleMenu[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RoleMenu) ReadField1(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *RoleMenu) ReadField2(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
	_field := make([]*menu.MenuInfo, 0, size)
	values := make([]menu.MenuInfo, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
		_elem.InitDefault()
...
func (p *RoleMenu) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("RoleMenu"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *RoleMenu) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("menuIds", thrift.LIST, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteListBegin(thrift.I64, len(p.MenuIds)); err != nil {
		return err
...
func (p *RoleMenu) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("menuInfo", thrift.LIST, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteListBegin(thrift.STRUCT, len(p.MenuInfo)); err != nil {
		return err
	}
	for _, v := range p.MenuInfo {
...
func (p *RoleMenu) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RoleMenu(%+v)", *p)
...
func (p *RoleListReq) GetPage() (v int64) {
	if !p.IsSetPage() {
		return RoleListReq_Page_DEFAULT
	}
	return p.Page
}

var RoleListReq_PageSize_DEFAULT int64 = 100

func (p *RoleListReq) GetPageSize() (v int64) {
	if !p.IsSetPageSize() {
		return RoleListReq_PageSize_DEFAULT
	}
	return p.PageSize
}
...
func (p *RoleListReq) IsSetPage() bool {
	return p.Page != RoleListReq_Page_DEFAULT
}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RoleListReq[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RoleListReq) ReadField1(iprot thrift.TProtocol) error {
...
func (p *RoleListReq) ReadField2(iprot thrift.TProtocol) error {
...
func (p *RoleListReq) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("RoleListReq"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *RoleListReq) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetPage() {
...
func (p *RoleListReq) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetPageSize() {
...
func (p *RoleListReq) String() string {
	...
	return fmt.Sprintf("RoleListReq(%+v)", *p)
...
type LogsInfo struct {
	...
	Operatorsr  string `thrift:"operatorsr,9" form:"operatorsr" json:"operatorsr" query:"operatorsr"`

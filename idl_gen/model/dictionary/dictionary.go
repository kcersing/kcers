...
type DictListReq struct {
	...
	Page     int64  `thrift:"page,3,optional" form:"page" json:"page" query:"page"`
	PageSize int64  `thrift:"pageSize,4,optional" form:"pageSize" json:"pageSize" query:"pageSize"`
}
...
var DetailListReq_DictionaryId_DEFAULT int64 = 0
...
func (p *DetailListReq) IsSetName() bool {
	return p.Name != DetailListReq_Name_DEFAULT
}

func (p *DetailListReq) IsSetDictionaryId() bool {
	return p.DictionaryId != DetailListReq_DictionaryId_DEFAULT
}
